"""
Django settings for alfahospital project.
...
SECRET_KEY = 'django-insecure-ce#lt(j)5ygxo!sj)$1ay)q_-2$abl+qba$mit&p$0hea13rd!'
...
ROOT_URLCONF = 'alfahospital.urls'
...
WSGI_APPLICATION = 'alfahospital.wsgi.application'
